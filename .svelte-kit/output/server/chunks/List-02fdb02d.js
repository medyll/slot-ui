import { q as noop, r as safe_not_equal, c as create_ssr_component, e as add_attribute, f as escape, n as null_to_empty, v as validate_component, d as get_current_component, b as compute_slots, i as getContext, a as subscribe, g as get_store_value, s as setContext, j as set_store_value } from "./index-fbd3851f.js";
import { c as createEventForwarder, V as VirtualList } from "./VirtualList-b0c0fb34.js";
...
const IconButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button${add_attribute("style", style, 0)} class="${escape(null_to_empty(className)) + " svelte-8f7jh8"}"${add_attribute("this", element, 0)}><span class="${"svelte-8f7jh8"}"><span class="${"icon svelte-8f7jh8"}">${validate_component(Icon, "Icon").$$render($$result, { icon, fontSize: iconFontSize }, {}, {})}</span>
		${slots.default ? slots.default({}) : ``}</span>
	${showShip ? `<span class="${"chip svelte-8f7jh8"}"></span>` : ``}
</button>`;
});
const css$3 = {
  code: "hr.svelte-kmnujy{border:none;border-top:1px solid var(--theme-border_color);background-color:var(--theme-border_color);display:block}hr.vertical.svelte-kmnujy{width:1px;height:50px;border-right:1px solid var(--theme-border_color);margin:0.25rem 0.5rem}",
  map: null
};
...
const Divider = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<hr class="${[
    escape(extensionClass[extension]) + " " + escape(className) + " svelte-kmnujy",
...
const ContentSwitcher = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(IconButton, "IconButton").$$render($$result, { icon, iconFontSize: "small" }, {}, {})}
...
const TopBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"flex-h flex-align-middle flex-main " + escape(className)}"${add_attribute("this", element, 0)}><div class="${"title flex-main text-500"}" style="${"order:" + escape(posTitle) + ";min-width:auto"}">${$$slots.menuBarTitle || Boolean(title) ? `${slots.menuBarTitle ? slots.menuBarTitle({}) : `
	...
	${$$slots.menuBarSwitcher ? `<div style="${"order:" + escape(posCloser)}">${validate_component(ContentSwitcher, "ContentSwitcher").$$render($$result, { parent: element, icon: "faSearch" }, {}, {
    default: () => {
...
const List = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<ul class="${"density-" + escape(density)}"${add_attribute("style", style, 0)}${add_attribute("this", element, 0)}>${$$slots.title || title ? `${slots.title ? slots.title({ listItem: item }) : `
