...
<script context="module" >import { windowsStore } from '/src/stores/windowStore';
const removeNode = (nodeRef) => {
    if (nodeRef?.parentNode)
        nodeRef.parentNode.removeChild(nodeRef);
};
</script>

<script >import { draggable } from '@neodrag/svelte';
import { getAppWindowStore } from '/src/stores/windowStore';
